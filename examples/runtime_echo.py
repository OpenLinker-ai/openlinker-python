...
async def main() -> None:
    worker = runtime.RuntimeWorker(
        platform_url=os.environ["OPENLINKER_PLATFORM_URL"],
        ...
        mtls=runtime.RuntimeMTLS(
            cert_file=os.environ["OPENLINKER_RUNTIME_CERT_FILE"],
            key_file=os.environ["OPENLINKER_RUNTIME_KEY_FILE"],
            ca_file=os.environ["OPENLINKER_RUNTIME_CA_FILE"],
        ),
